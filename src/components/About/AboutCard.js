      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify", fontSize: "1em", lineHeight: 1.8, color: "#e0d7f7", marginBottom: 18, fontWeight: 400 }}>
            Hello everyone! I'm <span className="purple" style={{ fontWeight: 600, fontSize: "1em" }}>Adarsh Kumar Gupta</span> from <span className="purple" style={{ fontWeight: 600, fontSize: "1em" }}>Muzaffarpur, Bihar, India</span>.<br /><br />
          ...
          <ul style={{ marginLeft: 0, paddingLeft: 22, marginBottom: 18 }}>
            <li className="about-activity" style={{ marginBottom: 7, color: "#c084f5", fontWeight: 500, fontSize: "0.97em", letterSpacing: 0.1 }}> 
              <ImPointRight style={{ marginRight: 8, fontSize: "1em" }} /> Playing games
            </li>
            <li className="about-activity" style={{ marginBottom: 7, color: "#c084f5", fontWeight: 500, fontSize: "0.97em", letterSpacing: 0.1 }}>
          ...
          <footer className="blockquote-footer" style={{ color: "#a588c0", marginTop: 10, fontSize: "0.95em", fontWeight: 500 }}>Adarsh</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
